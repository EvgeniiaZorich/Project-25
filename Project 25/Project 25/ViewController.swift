...
//  Project 25
//
//  Created by Евгения Зорич on 26.03.2023.
//
...
class ViewController: UICollectionViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, MCSessionDelegate, MCBrowserViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let connectedPeers = UIBarButtonItem(title: "Connections", style: .plain, target: self, action: #selector(showConnections))
        
        navigationItem.leftBarButtonItems = [importButton, connectedPeers]
